...
var odometer = function (ctx, parameters) {
    ...
    var valueBackColor = (undefined === parameters.valueBackColor ? '#EEEEEE' : parameters.valueBackColor);
    var valueForeColor = (undefined === parameters.valueForeColor ? '#111111' : parameters.valueForeColor);
